...
Rails.application.routes.draw do
  ...
  get "/contact-test", to: "contact#index_test"
  post "/contact-test", to: "contact#message_test"
  get "/contact-test2", to: "contact#index_test2"
  post "/contact-test2", to: "contact#message_test2"
